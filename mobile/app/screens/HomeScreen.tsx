      ...
      >
        ...
        <Box paddingHorizontal="m" marginBottom="m">
          <Box flexDirection="row" justifyContent="space-between" style={{ gap: theme.spacing.s }}>
            {[
              { label: t('Déclarer un Sinistre'), icon: 'add-circle', colorKey: 'error', bgKey: 'errorBg', screen: 'Sinistres', visible: true },
              { label: t('Rayer une Facture'), icon: 'card', colorKey: 'success', bgKey: 'successBg', screen: 'Quittances', visible: hasClientRole },
            ].filter(i => i.visible).map((item, i) => (
