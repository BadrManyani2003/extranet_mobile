...
<template>
  <Dialog :open="open" @update:open="emit('close')">
    <DialogContent class="w-[92%] sm:max-w-[400px] rounded-[2rem] p-10 font-['Outfit'] border-none shadow-2xl bg-white">
      <div class="text-center space-y-6">
        ...
        <div class="flex gap-4 pt-4">
          ...
          <Button 
            ...
            class="flex-1 rounded-xl h-12 font-bold shadow-xl text-white"
