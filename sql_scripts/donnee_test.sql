...
-- Re-initialisation des colonnes d'identite
...
-- Les identites sont automatiquement reinitialisees a 1 lors de la creation de la base.
GO
...
(@AdminId, 'Siege Social Rabat - Agdal', 'IDENT_RABAT_001', 'O', '20260101'),
(@AdminId, 'Direction Regionale Casablanca', 'IDENT_CASA_002', 'O', '20260101'),
...
-- Clients Entreprises
(1001, 'Groupe OCP S.A.', 'N', 'achats@ocpgroup.ma', 'Lotissement La Colline, Sidi Maarouf, Casablanca', '0522334455', 'O', 'O', '20260101'),
(1002, 'Maroc Telecom S.A.', 'N', 'direction.achats@mac.ma', 'Avenue Annakhil, Hay Ryad, Rabat', '0537719000', 'O', 'O', '20260101'),
(1003, 'Royal Air Maroc', 'N', 'assurances@ram.ma', 'Aeroport Mohammed V, Nouaceur', '0522434343', 'O', 'N', '20260101'), 
(1004, 'Groupe LabelVie', 'N', 'direction@labelvie.ma', 'Bd Al Qods, Sidi Maarouf, Casablanca', '0520334456', 'N', 'O', '20260101'), 
...
(2002, 'Khadija Bennouna', 'O', 'khadija.bennouna@email.ma', 'Avenue Hassan II, Residence Al Amal, Gueliz, Marrakech', '0667889900', 'O', 'O', '20260101'),
(2003, 'Youssef Amrani', 'O', 'youssef.amrani@email.ma', 'Hay El Wifaq, Avenue Hassan II, Temara', '0665112233', 'O', 'O', '20260101'),
...
-- =====================================================
-- 4. POLICES D'ASSURANCE (Automobile & Sante)
-- =====================================================
...
-- === BRANCHE SANTE ===
-- Maroc Telecom
(201, @ClientId2, @Comp1Id, 'Sante', 'SANTE-MAC-2026-001', '20261231', 'E', 'GROUPE', '20260101', '20260101'),
-- OCP
(202, @ClientId1, @Comp2Id, 'Sante', 'SANTE-OCP-2026-001', '20261231', 'E', 'GROUPE', '20260101', '20260101'),
-- RAM
(203, @ClientId3, @Comp3Id, 'Sante', 'SANTE-RAM-2026-001', '20261231', 'E', 'GROUPE', '20260601', '20260101'),
-- BMCE
(204, @ClientId5, @Comp1Id, 'Sante', 'SANTE-BMCE-2026-001', '20261231', 'E', 'GROUPE', '20260101', '20260101'),
-- Particuliers
(205, @ClientId6, @Comp4Id, 'Sante', 'SANTE-PAR-2026-001', '20261231', 'E', 'INDIV', '20260101', '20260101'),
(206, @ClientId7, @Comp5Id, 'Sante', 'SANTE-PAR-2026-002', '20261231', 'E', 'INDIV', '20260101', '20260101'),
(207, @ClientId9, @Comp4Id, 'Sante', 'SANTE-PAR-2026-003', '20261231', 'E', 'INDIV', '20260101', '20260101');
...
-- Maroc Telecom - Police Sante 201
...
-- Particuliers - Police Sante 207 (Naima)
...
-- =====================================================
-- 6. RISQUES (Vehicules Automobile)
-- =====================================================
...
(@PolAutoMAC1, 'Dacia Duster Essence', '12345-A-1', 'Vehicule Site Direction - Rabat', 'Ahmed Alami', '20260101', '20261231', 9001, 'O', '20260101'),
(@PolAutoMAC1, 'Renault Clio 5 Diesel', '67890-A-7', 'Vehicule Site Commercial - Casablanca', 'Khadija Mansouri', '20260101', '20261231', 9002, 'O', '20260101'),
(@PolAutoMAC1, 'Peugeot 3008 Allure', '11223-A-33', 'Vehicule Direction Regionale - Marrakech', 'Youssef Benjelloun', '20260101', '20261231', 9003, 'O', '20260101'),
(@PolAutoMAC1, 'Citroen Berlingo Utilitaire', '12346-A-2', 'Vehicule Technique - Maintenance', 'Tarik El Fassi', '20260101', '20261231', 9004, 'O', '20260101'),

-- Maroc Telecom Direction (102)
(@PolAutoMAC2, 'BMW Serie 3 320d', '99887-D-1', 'Vehicule de Fonction PDG', 'Rachid Benbrahim', '20260101', '20261231', 9005, 'O', '20260101'),
(@PolAutoMAC2, 'Audi A4 Avant', '99888-D-2', 'Vehicule de Fonction DGA', 'Laila Cherkaoui', '20260101', '20261231', 9006, 'O', '20260101'),

-- Flotte OCP 1 (103)
(@PolAutoOCP1, 'Toyota Land Cruiser Prado', '44556-C-1', 'Vehicule Site Minier Benguerir', 'Soufiane Belkhayat', '20260101', '20261231', 9007, 'O', '20260101'),
(@PolAutoOCP1, 'Nissan Navara', '44557-C-2', 'Vehicule Site Minier Khouribga', 'Mustapha Naciri', '20260101', '20261231', 9008, 'O', '20260101'),
(@PolAutoOCP1, 'Mitsubishi L200', '44558-C-3', 'Vehicule Site Laayoune', 'Nabil Slaoui', '20260101', '20261231', 9009, 'O', '20260101'),
...
-- Flotte RAM (105)
(@PolAutoRAM, 'Toyota Hilux Double Cabine', '33445-B-1', 'Transport Aeroport - Navette Equipage', 'Anass El Hariri', '20260101', '20261231', 9012, 'O', '20260101'),
(@PolAutoRAM, 'Mercedes Sprinter 315', '33446-B-2', 'Transport Personnel Aeroport Casa', 'Meriem Bensouda', '20260101', '20261231', 9013, 'O', '20260101'),
(@PolAutoRAM, 'Renault Master', '33447-B-3', 'Transport Bagages Aeroport', 'Sami Bennouna', '20260101', '20261231', 9014, 'O', '20260101'),

-- Flotte LabelVie (106)
(@PolAutoLBV, 'Ford Transit Custom', '77889-E-1', 'Vehicule Livraison - Carrefour Market', 'Khalid Sekkat', '20260101', '20261231', 9015, 'O', '20260101'),
(@PolAutoLBV, 'Renault Kangoo Express', '77890-E-2', 'Vehicule Livraison - Atacadao', 'Rania Bouazza', '20260101', '20261231', 9016, 'O', '20260101'),

-- Flotte BMCE (107)
(@PolAutoBMCE, 'Volkswagen Passat', '99001-F-1', 'Vehicule Service Direction', 'Othman Benjelloun', '20260101', '20261231', 9017, 'O', '20260101'),
(@PolAutoBMCE, 'Skoda Octavia', '99002-F-2', 'Vehicule Service Agences', 'Noureddine Omary', '20260101', '20261231', 9018, 'O', '20260101'),

-- Particuliers
(@PolAutoOmar, 'Hyundai Tucson 2024', '11223-G-1', 'SUV Blanc - Vehicule Personnel', 'Omar El Fassi', '20260101', '20260630', 9019, 'O', '20260101'),
(@PolAutoYoussef, 'Dacia Sandero Stepway', '11224-G-2', 'Citadine Grise - Vehicule Personnel', 'Youssef Amrani', '20260101', '20261231', 9020, 'O', '20260101'),
(@PolAutoNaima, 'Renault Captur', '11225-G-3', 'SUV Compact Bleu - Vehicule Personnel', 'Naima Berrada', '20260101', '20261231', 9021, 'O', '20260101'),
(@PolAutoHassan, 'Peugeot 208', '11226-G-4', 'Citadine Rouge - Vehicule Personnel', 'Hassan El Idrissi', '20260101', '20260930', 9022, 'O', '20260101');
...
-- Dacia Duster MAC
(1, 'Responsabilite Civile', 5000000.00, '0', '20260101'),
(1, 'Defense et Recours', 500000.00, '0', '20260101'),
...
(8002, 2, @PolAutoMAC1, NULL, 55002, '20260420', '20260421', 'E', '20260421', 8500.00, '2000', 0.00, 'Choc arriere parking siege Rabat - En attente expertise', '20260421'),
...
(8004, 12, @PolAutoRAM, NULL, 55004, '20260128', '20260129', 'C', '20260220', 28000.00, '4000', 24000.00, 'Collision avec glissiere securite A3 sortie Aeroport Mohammed V', '20260129'),
(8005, 13, @PolAutoRAM, NULL, 55005, '20260315', '20260316', 'C', '20260405', 12000.00, '3000', 9000.00, 'Accrochage avec bus CTM au terminal 2 - Aeroport Casa', '20260316'),
(8006, 19, @PolAutoOmar, NULL, 55006, '20260305', '20260305', 'C', '20260325', 6500.00, '2000', 4500.00, 'Accrochage parking Marjane Californie Casablanca - Tiers identifie', '20260305'),
(8007, 15, @PolAutoLBV, NULL, 55007, '20260710', '20260711', 'C', '20260801', 18500.00, '3000', 15500.00, 'Collision arriere livraison - Bd Moulay Ismail Casablanca', '20260711'),
(8008, 20, @PolAutoYoussef, NULL, 55008, '20261020', '20261022', 'C', '20261115', 4800.00, '1500', 3300.00, 'Bris pare-brise et retroviseur - Projection pierre autoroute', '20261022'),
...
-- === SINISTRES SANTE ===
(8010, NULL, @PolSanteMAC, 5001, 55010, '20260310', '20260312', 'C', '20260405', 3200.00, '640', 2560.00, 'Consultation specialiste + IRM cervicale - Clinique Nations Unies Rabat', '20260312'),
...
(8013, NULL, @PolSanteOCP, 5007, 55013, '20260415', '20260417', 'C', '20260510', 4500.00, '900', 3600.00, 'Hospitalisation 3j clinique Ain Sebaa - Appendicite aigue', '20260417'),
(8014, NULL, @PolSanteOCP, 5008, 55014, '20260901', '20260903', 'E', '20260903', 6500.00, '1300', 0.00, 'Accouchement cesarienne - Clinique Badr Casablanca', '20260903'),
(8015, NULL, @PolSanteRAM, 5011, 55015, '20260905', '20260907', 'C', '20260930', 2800.00, '560', 2240.00, 'Extraction dentaire + Couronne ceramique - Centre Dentaire Nations Unies', '20260907'),
(8016, NULL, @PolSanteRAM, 5010, 55016, '20261110', '20261112', 'E', '20261112', 1800.00, '360', 0.00, 'Consultation gynecologique + Echographie - Clinique Aviation Marrakech', '20261112'),
...
(8018, NULL, @PolSanteKhadija, 5016, 55018, '20260915', '20260917', 'C', '20261010', 3500.00, '700', 2800.00, 'Kinesitherapie 10 seances - Centre Reeducation Gueliz Marrakech', '20260917');
...
-- Documents Sante
(@PolSanteMAC, 601, 'Liste Adherents Sante MAC 2026'),
(@PolSanteMAC, 602, 'Contrat Assurance Groupe Sante MAC'),
...
(@UserClient1, '20260415 11:00:00', 'Demande ajout adherent sante MAC', 'E', NULL, 'I', '20260415 11:00:00'),

-- Laila (OCP)
(@UserClient2, '20260515 11:20:00', 'Demande ajout vehicule utilitaire flotte OCP', 'E', NULL, 'I', '20260515 11:20:00'),

-- Mehdi Ziani (Adherent MAC)
...
-- Fatima Zahra (Adherente RAM)
(@UserAdherent2, '20260701 08:30:00', 'Demande carte tiers payant RAM 2026', 'C', '20260701 16:00:00', 'S', '20260701 08:30:00'),
(@UserAdherent2, '20261115 11:00:00', 'Delai remboursement echographie depasse', 'E', NULL, 'S', '20261115 11:00:00');

-- Recuperation IDs reclamations
...
SELECT @R3 = Id FROM dbo.ReclamationsIdt WHERE FK_User_Client = @UserClient1 AND Sujet LIKE '%adherent%';
...
SELECT @R8 = Id FROM dbo.ReclamationsIdt WHERE FK_User_Client = @UserAdherent2 AND Sujet LIKE '%echographie%';

-- Messages des reclamations
INSERT INTO dbo.ReclamationsDet (FK_Reclamation_Id, FK_User_Id, DateMessage, Nature, Message) VALUES
-- R1 - Cartes vertes
(@R1, @UserClient1, '20260210 09:15:00', 'C', 'Salam, veuillez nous transmettre les cartes vertes 2026 pour notre flotte automobile (4 vehicules). Urgent.'),
(@R1, @AdminId, '20260210 10:30:00', 'A', 'Salam, nous avons bien recu votre demande. Les cartes vertes sont en cours d''emission. Delai 48h.'),
(@R1, @AdminId, '20260212 14:20:00', 'A', 'Les cartes vertes sont disponibles dans votre espace documents. Bonne reception.'),

-- R2 - Contestation franchise
(@R2, @UserClient1, '20260320 08:45:00', 'C', 'Nous contestons la franchise de 2500 DH sur sinistre 55001. Selon contrat, franchise RC est a 0 DH.'),
...
-- R3 - Ajout adherent sante
(@R3, @UserClient1, '20260415 11:00:00', 'C', 'Demande d''ajout d''un nouvel adherent a notre contrat sante groupe MAC. Formulaire en PJ.'),
(@R3, @CommercialId, '20260416 09:30:00', 'A', 'Votre demande a ete transmise au service adhesion. Traitement sous 72h.'),

-- R4 - Ajout vehicule OCP
(@R4, @UserClient2, '20260515 11:20:00', 'C', 'Demande d''ajout d''un Toyota Hilux a notre flotte OCP. Devis concessionnaire en piece jointe.'),
(@R4, @CommercialId, '20260516 09:45:00', 'A', 'Mme Bennani, votre demande est enregistree. Delai de traitement 5 jours ouvres pour avenant.'),

-- R5 - Suivi remboursement Mehdi
(@R5, @UserAdherent1, '20260520 14:30:00', 'C', 'Salam, mon dossier 55011 du 12 mai est toujours en attente de paiement. Delai depasse.'),
(@R5, @AdminId, '20260521 10:15:00', 'A', 'Salam M. Ziani, virement de 2450 DH effectue ce jour. Delai reception 48-72h. Excuses pour le retard.'),
(@R5, @UserAdherent1, '20260521 11:00:00', 'C', 'Merci pour votre reactivite. Bonne continuation.'),

-- R6 - Erreur calcul remboursement
(@R6, @UserAdherent1, '20260325 10:00:00', 'C', 'Erreur sur remboursement consultation : paye 400 DH, rembourse 280 DH au lieu de 320 DH (80%).'),
(@R6, @AdminId, '20260325 15:30:00', 'A', 'Nous verifions votre dossier. Le service comptable analyse l''ecart de 40 DH.'),
(@R6, @AdminId, '20260326 09:45:00', 'A', 'Erreur confirmee. Complement de 40 DH vire sous 48h. Toutes nos excuses.'),

-- R7 - Carte tiers payant RAM
(@R7, @UserAdherent2, '20260701 08:30:00', 'C', 'Bonjour, je n''ai pas recu ma carte tiers payant RAM 2026. Delai de 15 jours depasse.'),
(@R7, @AdminId, '20260701 16:00:00', 'A', 'Bonjour Mme Mansouri, votre carte est disponible en agence RAM aeroport. Possibilite envoi postal.'),
(@R7, @UserAdherent2, '20260702 09:00:00', 'C', 'Merci, je passerai la recuperer en agence cette semaine.'),

-- R8 - Delai echographie
(@R8, @UserAdherent2, '20261115 11:00:00', 'C', 'Mon dossier echographie du 12 novembre n''est toujours pas traite. Delai anormal.'),
(@R8, @AdminId, '20261117 14:00:00', 'A', 'Mme Mansouri, le dossier necessite une validation medicale complementaire. Delai supplementaire 48h.');
GO

-- =====================================================
-- 12. LIAISONS DE SIMULATION DE TEST (UserSimulationClients)
-- =====================================================
-- Administrateur (Id: 1) -> OCP (1001), RAM (1003), Khadija Bennouna (2002)
-- Commercial (Id: 2) -> Maroc Telecom (1002), Omar El Fassi (2001)
